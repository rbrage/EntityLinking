...
public class PrintToFile {
	...
	public void printHTMLToFile(String text, String folderPath, String filename, String prog) {
		PrintWriter writer;
		try {
				writer = new PrintWriter(folderPath + "/results_" + prog + "/HTML/"
						+ filename + ".html", "UTF-8");
				writer.print(text);
				writer.close();
	...
	public void printGraphToFile(String text, String folderPath, String filename, String prog) {
		PrintWriter writer;
		try {
				writer = new PrintWriter(folderPath + "/results_" + prog + "/GRAPH/"
						+ filename + ".txt", "UTF-8");
				writer.print(text);
				writer.close();
